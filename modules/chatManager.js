...
let clients = [];
/**
 * Takes messages and send them to the appropriate place in frontend
 * 
 * @param {String} fromId the socket id of the sender
 * @param {Object} data the message data object
 * @param {Object} io 
 */
const messageManager = function(fromId, data, io) {
